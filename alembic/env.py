...
Uses our ORM Base.metadata so Alembic can auto-generate migrations.
...
def get_url() -> str:
    """Read DB URL from our settings (synced with .env)."""
    from core.config import settings
    return settings.database.sync_url   # psycopg2 URL — Alembic needs sync
